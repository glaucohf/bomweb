...
<tiles:insertTemplate template="/WEB-INF/jsp/layout/template.jsp">
	...
	<tiles:putAttribute name="conteudo">
		<div id="inclusao">
			<span><strong class="titulo azul">Importar </strong><img src="<c:url value="/images/bomweb_setas.gif" />" /><strong class="titulo verde"> Tarifa Retroativa</strong></span>
			<img src="<c:url value="/images/bomweb_filtros_box_up.jpg" />" />	
			<form id="formUpLoad" action="<c:url value="/tarifa/uploadTarifaRetro" />" method="post" enctype="multipart/form-data">
				<fieldset>
					<p>
