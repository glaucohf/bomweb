...
<tiles:insertTemplate template="/WEB-INF/jsp/layout/template.jsp">
	<tiles:putAttribute name="conteudo">
		...
		<div class="white_content_content">
			Deseja realmente excluir: ${usuarioPerfil.usuario.nome} ?<br/>
		</div>
		<div class="white_content_footer">
			<input type="button" value="Confirmar" onclick="window.location='<c:url value="/usuario/delete/${usuarioPerfil.usuario.id}" />'">
